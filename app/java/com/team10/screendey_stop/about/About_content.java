package com.team10.screendey_stop.about;
...
import com.team10.screendey_stop.R;
import com.team10.screendey_stop.helper.Activity_intro;
...
class About_content {
    ...
    static MaterialAboutList createMaterialAboutList(final Context c) {
        ...
        appCardBuilder.addItem(new MaterialAboutActionItem.Builder()
                ...
                .setOnClickListener(ConvenienceBuilder.createWebsiteOnClickAction(c, Uri.parse("http://aymane.tk")))
                .build());
        ...
        authorCardBuilder.addItem(new MaterialAboutActionItem.Builder()
                ...
                .setOnClickListener(ConvenienceBuilder.createWebsiteOnClickAction(c, Uri.parse("https://www.paypal.me/Aymanelotfi/1")))
                .build());
        ...
        authorCardBuilder2.addItem(new MaterialAboutActionItem.Builder()
                ...
                .setOnClickListener(ConvenienceBuilder.createWebsiteOnClickAction(c, Uri.parse("https://github.com/AymaneLotfi")))
                .build());

        authorCardBuilder2.addItem(new MaterialAboutActionItem.Builder()
                .text("Designer Salim Moustanir / Walid elkhadiri / Ikram Belkaid ")
