package com.team10.screendey_stop.helper;
                            ...
                            RxImagePicker.with(Activity_EditNote.this).requestImage(Sources.GALLERY)
                                    .flatMap(new Function<Uri, ObservableSource<File>>() {
                                        ...
                                        public ObservableSource<File> apply(@NonNull Uri uri) throws Exception {
                                            return RxImageConverters.uriToFile(Activity_EditNote.this, uri, new File(Environment.getExternalStorageDirectory() + "/Android/data/com.team10.screendey_stop/" + helper_main.newFileName()));
                                        }
